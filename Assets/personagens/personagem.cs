...
public abstract class personagem : MonoBehaviour
{
   ...
   [Header("Estados dos personagens")]
    ...
    protected void blStatsSet( GameObject lsBullet)
    {
        ...
        LastBulletClass.blDistance = firePoint.position.x;
    }
    protected void fire()
    {
    ...
    protected void OnTriggerEnter2D(Collider2D gatilho)
    {
        if(gatilho.gameObject.tag == "morte_void")
        {
            hp = 0;
